	...
	<div class="container-fluid main-container">
		<div class="col-md-2 sidebar">
			<ul class="nav nav-pills nav-stacked">
				...
				<li class="active"><a href="/Nexus/admin/addUser">Add new
						user</a></li>
				<li><a href="#">Link</a></li>
				<li><a href="#">Link</a></li>
			</ul>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="main-login main-center">
						<form id="adduserform" class="" method="post" action="#">
							...
							<div class="form-group ">
								<a href="/Nexus/admin/listUsers" id="adduserbutton" class="btn btn-primary btn-lg btn-block login-button">Register
									New User</a>
							</div>
